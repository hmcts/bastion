locals {
  ...
  script_uri          = "https://raw.githubusercontent.com/hmcts/rdo-bastion/DTSPO-4817/terraform/modules/bastion/ConfigureBastion.sh?token=AALGNFWZHSOGDMXYJAFH54DBJGTEY"
}
