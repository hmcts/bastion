locals {
  environment             = "sbox"
  location                = "uksouth"
  image_id                = "/subscriptions/b3394340-6c9f-44ca-aa3e-9ff38bd1f9ac/resourceGroups/rdo-bastion-packer/providers/Microsoft.Compute/images/rdo-bastion-image-85811"
