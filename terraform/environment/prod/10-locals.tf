locals {
  environment             = "prod"
  location                = "uksouth"
  image_id                = "/subscriptions/2b1afc19-5ca9-4796-a56f-574a58670244/resourceGroups/rdo-bastion-packer/providers/Microsoft.Compute/images/rdo-bastion-image-85473"
  subnet                  = "10.48.0.0/27"
