locals {
  environment             = "prod"
  location                = "uksouth"
  image_id                = "/subscriptions/0978315c-75fe-4ada-9d11-1eb5e0e0b214/resourceGroups/rdo-bastion-packer/providers/Microsoft.Compute/images/rdo-bastion-image-85473"
  subnet                  = "10.48.0.0/27"
